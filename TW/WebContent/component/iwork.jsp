...
<%@ taglib prefix="s" uri="/struts-tags" %>
   ...
   <tr><td style="">
   <a href=" <s:url action="TopicListPage.do"><s:param name="topicid" value="iworkone.id"/></s:url>">
    <img style="border:none;"  src="<s:property value="iworkone.path"/>" width="139" height="54"/>
    </a>
    </td></tr>
   <tr><td style="">
   <a href=" <s:url action="TopicListPage.do"><s:param name="topicid" value="iworktwo.id"/></s:url>">
