...
<s:form theme = "simple" cssClass="tl" id = "form_comments" action="SendMailAction.do" method="post">
	...
	<div class="inner br">
		...
		<div id="author_info">
			...
			<p title="您的姓名，必填"><label class="label" for="author">称谓：</label><s:textfield cssClass="input inputname" name="author" id="author" tabindex="1"></s:textfield><label class="star" for="author">*</label></p>
			<s:fielderror><s:param>mailfrom</s:param></s:fielderror>
			<p title="您的 email, 必填， 但不会显示在网页上，您可能会收到回复通知邮件"><label class="label" for="mailfrom">电邮：</label><s:textfield cssClass="input inputemail" value="" name="mailfrom" id="mailfrom" tabindex="2"></s:textfield><label class="star" for="mailfrom">*</label></p>
			<s:fielderror><s:param>subject</s:param></s:fielderror>
			<p title="您评论的主题，必填"><label class="label" for="subject">主题：</label><s:textfield cssClass="input inputurl" name="subject" id="subject" tabindex="3"></s:textfield><label class="star" for="subject">*</label></p>
		</div>
