...
<%@ taglib prefix="s" uri="/struts-tags" %>
   ...
   <tr><td style="">
   <a href=" <s:url action="BrandArticleList.do"><s:param name="brandid" value="brandone.id"/></s:url>">
    <img style="border:none;"  src="<s:property value="brandone.path"/>" width="139" height="54"/>
    </a>
    </td></tr>
   <tr><td style="">
   <a href=" <s:url action="BrandArticleList.do"><s:param name="brandid" value="brandtwo.id"/></s:url>">
    <img style="border:none;"  src="<s:property value="brandtwo.path"/>" width="139" height="54"/>
    </a>
    </td></tr>
      <tr><td style="">
   <a href=" <s:url action="BrandArticleList.do"><s:param name="brandid" value="brandthree.id"/></s:url>">
